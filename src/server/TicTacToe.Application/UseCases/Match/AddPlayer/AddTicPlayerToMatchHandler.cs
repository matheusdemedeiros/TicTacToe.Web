...
{
    public class AddTicPlayerToMatchHandler : IRequestHandler<AddTicPlayerToMatchCommand, AddTicPlayerPlayerResponse>
    {
        ...
        public async Task<AddTicPlayerPlayerResponse> Handle(AddTicPlayerToMatchCommand request, CancellationToken cancellationToken)
        {
            ...
            var response = new AddTicPlayerPlayerResponse
            {
                MatchId = match.Id,
                PlayerId = player.Id,
